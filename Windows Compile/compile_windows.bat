@echo off
echo ========================================
echo   MixSplitR Windows Compiler
echo ========================================
echo.
...
if not exist "ffmpeg.exe" (
    ...
    echo Please download ffmpeg and place both ffmpeg.exe and ffprobe.exe here
...
if not exist "fpcalc.exe" (
    ...
    echo.
    echo Press Y to continue without it, or N to cancel
    choice /c YN /n
