...
"""
MixSplitR v8.0 PyInstaller Spec File - ONEDIR MODE (GUI + CLI)
Bundles runtime dependencies into a distribution folder to reduce EXE size and
avoid the startup/extraction overhead of a single-file build.
"""
...
_SPEC_PATH = _resolve_spec_path("MixSplitR_ONEDIR.spec")
...
# Let PyInstaller's built-in Qt hooks collect only the runtime modules/plugins
# reached from the imported Qt modules below. collect_all('PySide6') tends to
# pull in the full Qt payload and materially inflates Windows bundle size.
...
# =============================================================================
print("\n" + "="*60)
print("PyInstaller Build Configuration - ONEDIR MODE (GUI)")
print("="*60)
print(f"Target: {sys.platform}")
print("Mode: Directory bundle (onedir)")
...
print("Output: dist/MixSplitR/MixSplitR.exe (Windows) or dist/MixSplitR/ (Mac/Linux)")
print("="*60 + "\n")
